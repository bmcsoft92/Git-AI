...
const Solutions = () => {
  useEffect(() => {
    ...
    document.title = "Solutions d'Automatisation IA sur-mesure | Maia Elange";
    
    // Update or create meta description
    let metaDescription = document.querySelector('meta[name="description"]');
    if (metaDescription) {
      metaDescription.setAttribute('content', 'Découvrez nos solutions pour accélérer votre croissance (+30% de ventes), optimiser votre efficacité (+15h/semaine) et augmenter votre impact marketing (x3). Adaptées aux PME, ETI et grandes organisations.');
    } else {
